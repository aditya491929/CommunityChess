...
const Instructions = (props) => {
  return (
    <nav id="sidebar" className="navbar-light" style={{ backgroundColor: "#000000" }} >
      ...
      <strong>Community Chess <span role="img" aria-label="emoji">♟</span></strong> is a crypto-based community chess game with a reward model.
      ...
      <ul>
        ...
        <li>Wait for someone else to play (or just tell your friend to)</li>
      </ul>
      {/* </p> */}
